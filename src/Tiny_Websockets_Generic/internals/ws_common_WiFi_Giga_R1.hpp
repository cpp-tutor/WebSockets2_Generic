...
// From v1.7.0
#if WEBSOCKETS_USE_GIGA_R1_WIFI
  #warning Using GIGA_R1 WIFI in ws_common_WiFi_Giga_R1.hpp
#endif
  ...
  #if defined(CORE_CM7)
    #warning Using Giga R1 M7 core
    #define BOARD_NAME            "GIGA_R1_M7"
  #else
    #warning Using Giga R1 M4 core
    #define BOARD_NAME            "GIGA_M4"
  #endif

  #define USE_WIFI_GIGA_R1      true
...
// RS test for Giga_R1 WiFi only
//#define _WS_CONFIG_NO_SSL   true

#include <Tiny_Websockets_Generic/network/Giga_R1_WiFi/Giga_R1_WiFi_tcp.hpp>
